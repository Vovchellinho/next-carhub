import type { CatDetailsProps } from '@/types';
...
const CarDetails = ({isOpen, closeModal, car}: CatDetailsProps) => {
	return (
		<>
						...
						<div className='flex min-h-full items-center justify-center p-4 text-center'>
							<TransitionChild as={Fragment}
								...
								<DialogPanel className="relative w-full max-w-lg max-h=[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
									<button type='button' onClick={closeModal} className="absolute top-2 right-2 w-fit bg-primary-blue-100 p-2 rounded-full z-10">
										<Image src="/close.svg" alt="close" width={20} height={20} className="object-contain" />
									</button>

									<div className="flex-1 flex flex-col gap-3">
										<div className="relative w-fuul h-40 bg-pattern bg-cover bg-center rounded-lg">
